...
export function SchedulerScreen() {
  ...
  const nextRunsPreview = (() => {
    // Show next 5 runs within next 14 days (app must be open to trigger).
    const now = new Date();
    ...
    <div style={{ display: "grid", gap: 14 }}>
      ...
      <div className="card" style={{ display: "grid", gap: 12 }}>
        ...
        <div className="card" style={{ background: "rgba(255,255,255,0.04)" }}>
          ...
          <div style={{ marginTop: 10 }}>
            <small>
              Not: Bu uygulama içi scheduler’dır. **Uygulama açıkken** belirtilen saatlerde macro otomatik
              çalışır.
            </small>
          ...
          <div className="card" style={{ background: "rgba(255,255,255,0.04)" }}>
            ...
            <div style={{ marginTop: 10 }}>
              <small>
                ...
                Macro uzun sürerse ve slot kaçarsa <b>telafi etmez</b>, atlar. Bu yüzden hedef 20 iken bazen 18 gibi
                daha az çalışabilir.
              </small>
              <div style={{ marginTop: 8 }}>
                <small>
          ...
          <div className="card" style={{ background: "rgba(255,255,255,0.04)" }}>
            ...
            <div style={{ marginTop: 10 }}>
              <small>
                ...
                Böylece 09:10 başladıysa sonraki 10:10 olur (sabit saat başı değil).
              </small>
              <div style={{ marginTop: 8 }}>
                <small>
